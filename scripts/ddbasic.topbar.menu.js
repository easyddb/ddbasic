...
(function ($) {
   ...
   *   If true we want to open the form and link else we want to close it.
   */
  function ddbasicMobileMenu(open) {
    if (open) {
      // If the user clicked the active link, close it instead.
   ...
   *   If true we want to open the form and link else we want to close it.
   */
  function ddbasicUserLogin(open) {
    if (open) {
      // If the user clicked the active link, close it instead.
   ...
   *   If true we want to open the form and link else we want to close it.
   */
  function ddbasicUserAccount(open) {
    if (open) {
      // If the user clicked the active link, close it instead.
  ...
  $(document).ready(function () {
    ...
    $('.js-topbar-link.topbar-link-search').on('click touchstart', function (e) {
      ddbasicSearch(true);
      ddbasicMobileMenu(false);
      ddbasicUserLogin(false);
      ddbasicUserAccount(false);
      e.preventDefault();
    });
     ...
     */
    var subMenu = $('.pane-og-menu-og-single-menu-block');
    if (subMenu.length) {
